...
public class ScrollDateView extends View implements GestureDetector.OnGestureListener {
    ...
    public ScrollDateView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public ScrollDateView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void init(AttributeSet attrs) {
        ...
        mCursorSize = density * 14;
        mCenterTextSize = density * 18;
...
//		canvas.drawPath(mCenterIndicatorPath, mMarkPaint);
        ...
        float markHeight = (mHeight - mBottomSpace - mCenterTextSize - mTopSpace)/2;
    ...
    public interface OnWheelItemSelectedListener {
        void onWheelItemChanged(ScrollDateView wheelView, int position);

        void onWheelItemSelected(ScrollDateView wheelView, int position);
    }
